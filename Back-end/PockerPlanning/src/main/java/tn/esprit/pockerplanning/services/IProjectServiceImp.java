...
public class IProjectServiceImp implements IProjectService {
   ...
   /* @Override
    ...
    public List<Project> getProjectsByUserId(String id) {
        ...
        return projectsList;*/
        Set<Project> projectsSet = projectRepository.findByUserSetId(Long.parseLong(id));
    ...
    @Transactional
    @Override
    public Project assignProjectToDevelopers(String idProject, List<String> idDevelopers) {
        Project p = projectRepository.findById(idProject).orElseThrow(() -> new IllegalArgumentException("Project does not exist!"));
        {
            if(p.getNbDeveloper()>=idDevelopers.size()){
                for (String idDeveloper : idDevelopers) {
   ...
   /* @Override
    ...
    @Override
    public List<User> getAllDevelopers(String id) {
        return userRepository.findByRoleAndNotAssignedToProject(Role.DEVELOPER, String.valueOf(Long.valueOf(id)));
    }
    @Override
    public List<User> getDevelopersByProjectId(String id) {
        return userRepository.findByProjectSetIdAndRole(String.valueOf(Long.parseLong(id)), Role.DEVELOPER);
    }
    ...
    @Override
    public List<Project> getImportedProjects(String userId) {
        return projectRepository.findByUserSetIdAndBadgetEquals(Long.parseLong(userId), 0);
    }
