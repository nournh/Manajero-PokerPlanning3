...
import tn.esprit.pockerplanning.services.IUserStoryServiceImp;
import tn.esprit.pockerplanning.services.NoteService;
...
public class NoteController {
    ...
    //non utiliser
    public List<Note> findNoteByUserStory(@PathVariable  String idUserStory) {
  ...
  public String getUserStoryIdForNote(@PathVariable long noteId){
    ...
    public ResponseEntity<Note> updateNote(@PathVariable String idNote, @RequestBody Note noteDetails) {
